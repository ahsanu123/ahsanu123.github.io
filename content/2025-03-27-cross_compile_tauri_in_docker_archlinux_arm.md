...
- if error when docker run, try to add qemu -> `sudo pacman -S qemu-user-static qemu-user-static-binfmt` then `docker run  --privileged multiarch/qemu-user-static --reset -p yes`
